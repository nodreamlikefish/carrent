...
<%!public static final String REPAIRFACTORY_LIST_URL = "pages/back/admin/fuelType/list.action";%>
<jsp:include page="/WEB-INF/pages/plugins/back/back_header.jsp" />
<script type="text/javascript"
	src="js/pages/back/admin/repairFactory/repairFactory_add.js"></script>
			...
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<table class="table table-condensed">
						...
						<tbody>
							<tr>
								<td class="text-center"><input type="text" id="repairFactory_add"
									class="form-control" placeholder="请输入维修厂厂商"></td>
