...
<%!
	public static final String CARCOLOR_ADD_URL="pages/back/admin/carColor/addPre.action" ;
%>
					...
					<table class="table table-condensed">
						<thead>
							<tr>
								...
								<th class="text-center"><a href="<%=CARCOLOR_ADD_URL%>"><button id="edit-add"
						...
						<tbody>
							<c:forEach items="${allCarColor}" var="carColor">
								<tr>
									<td class="text-center"><span id="id-${carColor.id}"
										style="cursor: pointer;">${carColor.id}</span></td>
									<td class="text-center"><input type="text" id="color-${carColor.id}"
										class="form-control" value="${carColor.color}"></td>
									<td class="text-center">
										<button id="edit-update-${carColor.id}" class="btn btn-warning">
											<span class="glyphicon glyphicon-edit"></span>&nbsp;编辑
										</button>

										<button id="edit-delete-${carColor.id}" class="btn btn-warning">
