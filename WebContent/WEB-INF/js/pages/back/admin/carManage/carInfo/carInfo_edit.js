	...
	$("button[id=edit-add]").each(function(){
		$(this).on("click",function(){
			...
			if (plateNo == "" || carOwner == "" || carBelong == "" || carType == "" 
				...
				$.post("pages/back/admin/carManage/carInfo/edit.action",{"carId":carId,"plateNo":plateNo,"carOwner":carOwner,
...
function deleteInfo(){
	var carId = $("#carId").val() ;
	$.post("pages/back/admin/carManage/carInfo/delete.action",{"carId":carId},function(data){
